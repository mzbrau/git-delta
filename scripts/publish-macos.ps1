param(
    ...
    [string] $OutputPath = "artifacts/publish/GitDelta-osx-arm64"
)
...
$publishProfile = Join-Path $repoRoot "src/GitDelta.App/Properties/PublishProfiles/osx-arm64-folder.pubxml"
