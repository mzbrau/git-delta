...
/// (<c>AddGitDeltaAIWithFakeAgent</c>) with a <see cref="FakeAgentClient"/> standing in for the
...
public sealed class AiReviewCoordinatorIntegrationTests
{
    ...
    private sealed class Harness : IAsyncDisposable
    {
            ...
            Action<AppSettings>? configureSettings = null)
        {
            ...
            var tempRoot = Path.Combine(Path.GetTempPath(), "GitDelta.AI.Tests", Guid.NewGuid().ToString("N"));
            ...
            bool ownsTempRoot)
        {
            ...
            services.AddGitDeltaAIWithFakeAgent(scriptFactory);
