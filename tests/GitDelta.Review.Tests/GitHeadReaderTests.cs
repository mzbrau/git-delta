...
public sealed class GitHeadReaderTests
{
    ...
    {
        var root = Path.Combine(Path.GetTempPath(), "gitdelta-head-" + Guid.NewGuid().ToString("N"));
    ...
    {
        var root = Path.Combine(Path.GetTempPath(), "gitdelta-worktree-" + Guid.NewGuid().ToString("N"));
        var realGit = Path.Combine(Path.GetTempPath(), "gitdelta-gitdir-" + Guid.NewGuid().ToString("N"));
