...
public partial class WorkingCopyViewModel
{
    ...
    private async Task ConfirmMagicCommitAsync()
    {
        ...
        try
        {
            ...
            // Synchronous progress: AppendMagicCommitActivity already marshals to the UI thread.
            // System.Progress<T> posts via SynchronizationContext and can drop reports in tests/headless.
            var activity = new SyncProgress<string>(AppendMagicCommitActivity);
