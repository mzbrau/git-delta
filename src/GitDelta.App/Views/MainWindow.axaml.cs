...
public partial class MainWindow : Window
{
    ...
    private void OnOpened(object? sender, EventArgs e)
    {
        ...
        if (global::GitDelta.App.App.Services.GetService(typeof(AvaloniaConfirmDialog)) is AvaloniaConfirmDialog confirm)
            confirm.Owner = this;
        if (global::GitDelta.App.App.Services.GetService(typeof(AvaloniaStashDialog)) is AvaloniaStashDialog stashDialog)
    ...
    private void OnPullRequestSelectionChanged(object? sender, SelectionChangedEventArgs e)
    {
        ...
        if (list.SelectedItem is GitDelta.GitHub.PullRequestSummary summary)
