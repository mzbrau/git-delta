...
/// patch into a canonical <c>FileDiff</c> is <c>GitDelta.Diff</c>'s job, composed on top of
/// this service so that <c>GitDelta.Git</c> never references <c>GitDelta.Diff</c>.
/// </summary>
